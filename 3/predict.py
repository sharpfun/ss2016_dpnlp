...
tensor_initial1 = [x for x in model.shared_variables if x.name == "initial_state"][0]
tensor_initial2 = [x for x in model.shared_variables if x.name == "initial_state"][1]
tensor_initial3 = [x for x in model.shared_variables if x.name == "initial_state"][2]
